...
import com.abc.modules.sys.dto.region.Region;
import com.abc.modules.sys.dto.region.RegionCity;
import com.abc.modules.sys.dto.region.RegionProvince;
import com.abc.modules.sys.entity.SysRegionEntity;
import com.abc.modules.sys.enums.RegionLeafEnum;
import com.abc.modules.sys.enums.RegionLevelEnum;
import com.abc.modules.sys.dao.SysRegionDao;
...
public class SysRegionServiceImpl extends BaseServiceImpl<SysRegionDao, SysRegionEntity> implements SysRegionService {
	...
	public void update(SysRegionDTO dto) {
		...
		if(entity.getId().equals(entity.getPid())){
			throw new BusinessException(ErrorCode.SUPERIOR_REGION_ERROR);
		}
